...
This module contains unit tests for the S3LifecycleManager class. It tests the funcionalidades
...
class TestS3LifecycleManager(unittest.TestCase):
    ...
    def test_list_buckets(self):
        ...
        self.assertTrue(any(bucket["Name"] == "test-bucket" for bucket in buckets))
        self.assertTrue(any(bucket["Name"] == "empty-bucket" for bucket in buckets))
    ...
    def test_process_buckets_no_rules(self):
        ...
        bucket_names = ["test-bucket", "empty-bucket"]
        self.manager.process_buckets(bucket_names)
