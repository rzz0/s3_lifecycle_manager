...
class TestS3LifecycleBackupManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.patcher = patch("s3_lifecycle_manager.backup_manager.boto3.client")
    ...
    def test_export_lifecycle_policies(self):
        ...
        lifecycle_policies = {
            "test-bucket-1": lifecycle_policy["Rules"],
            "test-bucket-2": [],
        }
    ...
    def test_restore_lifecycle_policies(self):
        ...
        with open(backup_file, "w", encoding="utf-8") as file:
            json.dump(lifecycle_policy["Rules"], file, ensure_ascii=False, indent=4)
    ...
    def test_list_backups(self):
        ...
        for file_name in backup_files:
            with open(
                os.path.join(self.backup_manager.backup_dir, file_name),
                mode="a",
                encoding="utf-8",
            ):
                pass
