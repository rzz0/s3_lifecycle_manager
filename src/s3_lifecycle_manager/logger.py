...
def configure_logging(log_filename: str = 'LOG_app.log',
    ...
    Args:
        ...
        log_dir (Optional[str]): Directory where the log file will be saved. Default is None,
        which means the current directory.
        max_bytes (int): Maximum size of the log file in bytes before rolling over. Default is
        10^6 bytes.
